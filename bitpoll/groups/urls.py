...
urlpatterns = [
    ...
    url(r"^g/([a-zA-Z0-9_\-\.]+)/action/(\d+)$", group_action, name="groups_action"),
    url(
        r"^invitations/(\d+)/action", invitation_action, name="groups_invitation_action"
    ),
    url(r"^invitations/(\d+)/withdraw", withdraw_invite, name="groups_withdraw_invite"),
]
