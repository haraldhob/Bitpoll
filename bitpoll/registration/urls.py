...
urlpatterns = [
    url(
        r"^change_email/([a-zA-Z0-9:_-]+)$",
        change_email,
        name="registration_change_email",
    ),
    url(
        r"^request_successful/([a-zA-Z0-9.\-_+]+@[a-zA-Z0-9.\-_]+)$",
        request_successful,
...
if settings.REGISTER_ENABLED:
    urlpatterns += [
        url(r"^request_account$", request_account, name="registration_request_account"),
        url(
            r"^create_account/([a-zA-Z0-9:_-]+)$",
            create_account,
